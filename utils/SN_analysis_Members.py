...
myc = conn.cursor()
res_14=myc.execute('select groupmembersbase.member_id from groupmembersbase where groupmembersbase.group_id=14').fetchall()
mr_14=pd.DataFrame(res_14)[0].tolist()

res_11787=myc.execute('select groupmembersbase.member_id from groupmembersbase where groupmembersbase.group_id=11787').fetchall()
mr_11787=pd.DataFrame(res_11787)[0].tolist()

res_691=myc.execute('select groupmembersbase.member_id from groupmembersbase where groupmembersbase.group_id=691').fetchall()
mr_691=pd.DataFrame(res_691)[0].tolist()

res_577=myc.execute('select groupmembersbase.member_id from groupmembersbase where groupmembersbase.group_id=577').fetchall()
mr_577=pd.DataFrame(res_577)[0].tolist()

res_25=myc.execute('select groupmembersbase.member_id from groupmembersbase where groupmembersbase.group_id=25').fetchall()
mr_25=pd.DataFrame(res_25)[0].tolist()

res_430=myc.execute('select groupmembersbase.member_id from groupmembersbase where groupmembersbase.group_id=430').fetchall()
mr_430=pd.DataFrame(res_430)[0].tolist()

res_316=myc.execute('select groupmembersbase.member_id from groupmembersbase where groupmembersbase.group_id=316').fetchall()
mr_316=pd.DataFrame(res_316)[0].tolist()

res_1614=myc.execute('select groupmembersbase.member_id from groupmembersbase where groupmembersbase.group_id=1614').fetchall()
mr_1614=pd.DataFrame(res_1614)[0].tolist()


#[ 691,  577, 25, 430, 316, 1614]
members_result = {}
...
for i_group in group_ids:
    ...
    for grn in group_n:
        ...
        plt.savefig('C:\projects\ProjectInsta\ProjectInsta_TR\dbdata\plot_1.png')
    ...
    for k_group in group_ids:
        if k_group!=i_group:
            ...
            if len(intersection)>0:
                ...
                nx.draw(graph)
                plt.savefig('C:\projects\ProjectInsta\ProjectInsta_TR\dbdata\plot_2.png')
